...
export default function ReportsDiagnose() {
  ...
  return (
    <div className="p-6 max-w-[1600px] mx-auto space-y-6">
      <h1 className="text-xl font-bold text-slate-700 dark:text-zinc-200 uppercase tracking-widest mb-6 flex gap-2 items-center">
        DIAGNOSE REPORT <span className="text-slate-300 font-light">/</span> 
        <span 
