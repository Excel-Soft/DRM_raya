...
export default function ServiceBvChecking() {
    ...
    return (
        <div className="bg-[#f8fafc] font-sans p-4 min-h-screen dark:bg-zinc-950">
            ...
            <div className="mb-6 flex items-center">
                <h2 className="text-[17px] font-bold text-[#475569] uppercase tracking-tight dark:text-zinc-400">BV SYSTEM</h2>
            </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
                    <div>
                        ...
                        <Input
                            value="M. Shahbaz"
                            disabled
                            className="bg-slate-50 border-slate-200 text-slate-500 text-[13px] h-9 dark:bg-zinc-900 dark:text-zinc-400 dark:border-zinc-800"
                        />
                    </div>
                    <div>
                        <label className="block text-[13px] font-semibold text-slate-600 mb-2 dark:text-zinc-300">Select Type</label>
                        <Select>
                            ...
                            <SelectContent>
                                ...
                                <SelectItem value="type2">Premium</SelectItem>
                            </SelectContent>
                        </Select>
                    </div>
                    <div>
            ...
            <div className="bg-white rounded-[4px] shadow-sm border border-slate-100 p-6 dark:bg-zinc-900 dark:border-zinc-800">
                <div className="mb-4">
                    <h3 className="text-[15px] font-bold text-[#475569] dark:text-zinc-400">BV View</h3>
                </div>
                    ...
                    <Table>
                        <TableHeader>
                            <TableRow className="bg-[#d1fae5] border-b border-slate-200 hover:bg-[#d1fae5] dark:border-zinc-800 dark:bg-zinc-900 dark:hover:bg-zinc-800">
                                ...
                                <TableHead className="text-[12px] font-bold text-slate-800 py-3 whitespace-nowrap dark:text-zinc-100">Receive Date</TableHead>
                            </TableRow>
                        </TableHeader>
                        <TableBody>
