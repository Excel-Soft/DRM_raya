...
export default function ServiceACustomer() {
    const [searchTerm, setSearchTerm] = useState("");
    const [mockData] = useState<RowData[]>([
        { company: "WebExcels", person: "Ali Raza", grade: "A", date: "2026-04-02" },
        { company: "TechNova", person: "Sara Ahmed", grade: "A-", date: "2026-04-01" },
        { company: "Nexus", person: "Kamran Khan", grade: "B+", date: "2026-03-30" },
    ]);
