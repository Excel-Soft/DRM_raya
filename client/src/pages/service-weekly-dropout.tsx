...
type RowData = { company: string; person: string; purpose: string; service: string; note: string; date: string; };

export default function ServiceWeeklyDropout() {
