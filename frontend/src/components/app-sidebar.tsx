...
const menuItems: MenuItem[] = [
  ...
  // permKey must match the `name` field in drm.menu_permissions
  {
    ...
    items: [
      ...
      { title: "Gm Bv Pool", url: "/gm-pool/add-gm", icon: PlusCircle },
      { title: "In service Report", url: "/reports/in-service", icon: FileText },
      { title: "Public Pool(Pick up)", url: "/customers/public-pool", icon: Database },
      { title: "Public Pool(Follow up)", url: "/customers/public-pool-followup", icon: Database },
      { title: "Invoice Pool", url: "/sales/invoice-pool", icon: FileText },
      { title: "Active Clients", url: "/sales/active-clients", icon: Users },
    ],
  },
  {
  ...
  { title: "Branches", icon: Building2, url: "/drm/branches", permKey: "Branches" },
  {
...
const DEPT_NAME_TO_ROLES: Record<string, string[]> = {
  ...
  "Portfolio": ["admin", "verification_manager", "hod", "super_hod", "seo_smm_manager", "seo_smm_executive"],
  "Web Excels": ["admin", "super_hod"],
  "Trade Assurance": ["admin", "sales_executive", "sales_manager", "hod", "super_hod"],
  "Customer": ["admin", "sales_executive", "sales_manager", "sales_assistant_manager", "account_manager", "manager", "hod", "super_hod", "qa_manager", "verification_manager", "dd_manager", "dd_executive", "product_posting_manager", "product_posting_executive", "posting_executive", "it_manager", "it_executive", "reception_manager", "service_manager", "service_executive", "software_manager", "software_executive", "lead_manager", "lead_executive"],
  ...
  "Notice": ["admin", "super_admin", "reception_manager", "seo_smm_manager", "seo_smm_executive"],
  "Notice Board": ["admin", "super_admin", "reception_manager", "seo_smm_manager", "seo_smm_executive"],
  ...
  "Reports": ["admin", "super_hod", "hod", "service_manager", "service_executive", "software_manager", "software_executive", "lead_manager", "lead_executive", "marketing_manager", "it_manager", "it_executive", "reception_manager", "account_manager"],
