...
export const routeRegistry: RouteEntry[] = [
  ...
  { path: "/service/my-penalties", component: "ServiceMyPenalties", title: "My Penalties", module: "Service", sidebarVisible: false, isInternal: true, allowedRoles: ["admin", "service_manager", "service_assistant_manager", "service_executive"] },
