...
export function RunningProjectView() {
    const {
        queryClient,
    location,
    searchString,
        ...
        <div className="bg-white rounded-2xl shadow-sm overflow-hidden border border-slate-100 dark:bg-zinc-900 dark:border-zinc-800">
          <div className="p-4 sm:p-5 space-y-6">
            <div className="grid grid-cols-1 xl:grid-cols-3 gap-4">
              {runningProjectTopBoxes.map((box: any) => (
              ...
              <Table>
                <TableHeader>
                  <TableRow className="border-b border-slate-100 hover:bg-transparent dark:border-zinc-800">
                    {["No#", "Company", "Person", "Project", "Status", "Time", "Assign", "Create Date", "Assign Date", "Finish Date", "Spent Time", "Link", "Action"].map((head: any) => (
                      <TableHead
                        key={head}
