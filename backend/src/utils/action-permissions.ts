...
export const ACTION_PERMISSIONS: Record<string, ActionPolicy> = {
  ...
  "service.customer.create": {
    module: "service",
    description: "Onboard a customer into the service module.",
    allowRole: isServiceWriteRole,
    adminOverride: true,
    audit: true,
  ...
  "service.feedback.create": {
    module: "service",
    description: "Record a customer satisfaction rating.",
    allowRole: isServiceWriteRole,
    adminOverride: true,
    audit: true,
    entityType: "ServiceCustomerFeedback",
    message: "You are not authorized to manage service records.",
  },
  "service.sample.create": {
    module: "service",
    description: "Log a customer sample request.",
    allowRole: isServiceWriteRole,
    adminOverride: true,
    audit: true,
    entityType: "ServiceSampleRequest",
    message: "You are not authorized to manage service records.",
  },
};
