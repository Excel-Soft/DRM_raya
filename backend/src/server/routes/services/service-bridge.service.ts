...
export const bridgeToGm = makeStub("bridgeToGm");
export const bridgeToVas = makeStub("bridgeToVas");
export const bridgeToBv = makeStub("bridgeToBv");
export const ensureBridgeLinksTable = makeStub("ensureBridgeLinksTable");
export const mapServiceBridgeError = makeStub("mapServiceBridgeError");
