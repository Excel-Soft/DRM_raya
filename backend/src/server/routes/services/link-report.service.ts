...
export const listUsersForReport = makeStub("listUsersForReport");
export const listLinkReport = makeStub("listLinkReport");
export const getVerification = makeStub("getVerification");
export const verifyCommission = makeStub("verifyCommission");
export const createLinkReport = makeStub("createLinkReport");
