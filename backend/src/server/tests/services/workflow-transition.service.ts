...
export const validateTransition = makeStub("validateTransition");
export const validateExtensionRequestInput = makeStub("validateExtensionRequestInput");
export const resolveWorkflowRouting = makeStub("resolveWorkflowRouting");
export const WorkflowTransitionError = makeStub("WorkflowTransitionError");
