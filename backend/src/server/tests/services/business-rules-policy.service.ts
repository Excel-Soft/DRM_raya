...
export const checkWalletNegativeBalanceAllowed = makeStub("checkWalletNegativeBalanceAllowed");
export const getApprovedProfitLossFormulaVersion = makeStub("getApprovedProfitLossFormulaVersion");
export const checkAbForceCloseAllowed = makeStub("checkAbForceCloseAllowed");
export const checkReopenAllowed = makeStub("checkReopenAllowed");
