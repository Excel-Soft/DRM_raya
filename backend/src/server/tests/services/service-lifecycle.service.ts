...
export const validateServiceTransition = makeStub("validateServiceTransition");
export const isLegalServiceTransition = makeStub("isLegalServiceTransition");
export const SERVICE_LOGICAL_TO_STATUS = makeStub("SERVICE_LOGICAL_TO_STATUS");
export const ServiceLifecycleError = makeStub("ServiceLifecycleError");
